...
<p><a href="/files/cv-schlichtig.pdf" class="btn btn--primary"><i class="fa fa-fw fa-download" aria-hidden="true"></i> Download CV (PDF)</a></p>
...
- **BMBF Software Campus** — *API\_ASSIST*, 100,000 EUR, 02/2023–08/2024 — **Principal Investigator**
  *Specifiable automated detection of API misuse in CI pipelines*; industry partner: Trumpf SE + Co. KG
...
- Reviewer: [IEEE Transactions on Software Engineering](https://www.computer.org/csdl/journal/ts), [ACM Computing Surveys](https://dl.acm.org/journal/csur), [The Journal of Systems & Software](https://www.sciencedirect.com/journal/journal-of-systems-and-software)
- PC Member: [SANER 2025](https://conf.researchr.org/home/saner-2025) (Tool Demo Track)
